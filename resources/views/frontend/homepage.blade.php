            ...
            @foreach($cars as $car)
                <div class="col mb-5">
                    <div class="card h-100 ">
                        <!-- Sale badge-->
                        <div
                        class="badge badge-custom {{ $car->status == 'tersedia' ? 'bg-success' : 'bg-warning'}} bg-warning text-white position-absolute"
                        style="top: 0; right: 0"
                        >
                            {{ $car->status }}
                        </div>
                        ...
                        <div class="text-center">
                            <a class="btn btn-primary mt-auto" href="https://wa.me/082495980567?text=hii Zaki%20saya%20mau sewa%20mobil%20{{$car->nama_mobil}}%20nya..!">Sewa</a>
                            <a
